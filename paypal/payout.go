...
func (c *Client) CreateBatchPayout(ctx context.Context, bm pay.BodyMap) (ppRsp *CreateBatchPayoutRsp, err error) {
...
func (c *Client) ShowPayoutBatchDetails(ctx context.Context, payoutBatchId string, bm pay.BodyMap) (ppRsp *PayoutBatchDetailRsp, err error) {
	if payoutBatchId == pay.NULL {
