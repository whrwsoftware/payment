...
func (c *Client) CreateOrder(ctx context.Context, bm pay.BodyMap) (ppRsp *CreateOrderRsp, err error) {
...
func (c *Client) OrderDetail(ctx context.Context, orderId string, bm pay.BodyMap) (ppRsp *OrderDetailRsp, err error) {
	if orderId == pay.NULL {
		return nil, errors.New("order_id is empty")
	}
...
func (c *Client) OrderAuthorize(ctx context.Context, orderId string, bm pay.BodyMap) (ppRsp *OrderAuthorizeRsp, err error) {
	if orderId == pay.NULL {
		return nil, errors.New("order_id is empty")
	}
...
func (c *Client) OrderCapture(ctx context.Context, orderId string, bm pay.BodyMap) (ppRsp *OrderCaptureRsp, err error) {
	if orderId == pay.NULL {
		return nil, errors.New("order_id is empty")
	}
...
func (c *Client) OrderConfirm(ctx context.Context, orderId string, bm pay.BodyMap) (ppRsp *OrderConfirmRsp, err error) {
	if orderId == pay.NULL {
		return nil, errors.New("order_id is empty")
	}
