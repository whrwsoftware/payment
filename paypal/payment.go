...
func (c *Client) PaymentReauthorize(ctx context.Context, authorizationId string, bm pay.BodyMap) (ppRsp *PaymentReauthorizeRsp, err error) {
	if authorizationId == pay.NULL {
		return nil, errors.New("authorization_id is empty")
	}
...
func (c *Client) PaymentAuthorizeCapture(ctx context.Context, authorizationId string, bm pay.BodyMap) (ppRsp *PaymentAuthorizeCaptureRsp, err error) {
	if authorizationId == pay.NULL {
		return nil, errors.New("authorization_id is empty")
	}
...
func (c *Client) PaymentCaptureRefund(ctx context.Context, captureId string, bm pay.BodyMap) (ppRsp *PaymentCaptureRefundRsp, err error) {
	if captureId == pay.NULL {
		return nil, errors.New("capture_id is empty")
	}
